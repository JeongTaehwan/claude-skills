...
## 이럴 땐 아니다
- 무엇을 검증했다고 선언할 수 있는 요구사항 목록이 필요한 것이라면 `development/owasp-asvs.md`
- 위험 전반의 우선순위를 잡는 단계는 `development/owasp-top-10.md`
- 이 기능이 어떤 공격을 받을 수 있는지 발굴하는 설계 활동은 `development/owasp-threat-modeling.md`
