...
## 이럴 땐 아니다
- 위협 모델링을 *어떻게 하는가* — 절차, STRIDE 의 각 항목이 무엇인지 — 는 도구가 아니라 `development/owasp-threat-modeling.md`
- 도출된 위협을 검증 가능한 요구사항으로 옮기는 단계는 `development/owasp-asvs.md`
- 각 위협의 구체적 완화 구현 방법은 `development/owasp-cheat-sheet-series.md`
