...
## 이럴 땐 아니다
- 개념과 원칙, 인용할 원전이 필요한 거라면 `development/sre-book.md`
- SRE 시리즈 전체의 입구는 `development/google-sre-books.md`
...
- 관측 데이터를 실제로 수집·전파하는 계측 방법은 `development/opentelemetry-docs.md`
