...
## 이럴 땐 아니다
- 통과/실패를 판정할 수 있는 검증 항목 목록이 필요하다면 Top 10 으로는 안 된다 — `development/owasp-asvs.md`
- "그래서 어떻게 막나"의 구현 지침은 `development/owasp-cheat-sheet-series.md`
- 우리 시스템 고유의 위협을 발굴하는 활동은 `development/owasp-threat-modeling.md`
